...
/**
 *@file tarray.h
 *This file is templating the array being used to store the college classes
 *@author Matthew Aberegg
 *@date 10/8/2015
*/

/**
 *@note This file is useless as it's missing tarray.template and is never included by the program
*/
